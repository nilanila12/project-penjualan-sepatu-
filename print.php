...
if(isset($_POST['finish'])){
    ...
    $num = 'TokoOnline'.$_POST['pos'].' - ('.$_POST['nama'].')';
    $nom = $_POST['kota'];
    $date = date("d M Y");
?>
<style type="text/css">
        ...
        <tr>
            <td colspan="2" style="width: 100%">
                <div class="zone" style="height: 34mm;position: relative;font-size: 5mm;">
                    ...
                    <span style="position: absolute; left: 32mm; top: 10mm; font-size: 28px; color: red">Toko Online</span><br />
                    <span style="position: absolute; left: 32mm; top: 18mm; font-size: 16px;">Kembiritan, <?php echo $date; ?></span>
