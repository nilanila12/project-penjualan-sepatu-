  ...
  <div class="container">
    ...
    <div class="rubypedia-parallax">
      <div class="container" style="text-align: center;padding-top: 160px">
        <div class="row">
          <span class="border" style="margin-left: 300px; color: white;padding: 18px;font-weight: bold; font-family: verdana; font-size: 25px;letter-spacing: 5px;">Original</span><br>
          <span class="border" style="font-weight: bold; color: white; padding: 18px;font-size: 60px;letter-spacing: 10px;">Toko Online</span><br><br><br>
          <span class="border" style="background-color: #111;color: #fff;padding: 18px;font-size: 25px;letter-spacing: 10px;">Belilah-Belilah !!!</span>
        </div>
      </div>
    </div>
    ...
    <div class="woman" id="woman">
        <div class="section">
          ...
          <div class="container">
            ...
            <div class="col-md-12">
                <h2 class="text-center">Sepatu</h2>
                <hr>
                <br>
              </div>
            <!-- row -->
                   ...
                   <?php $i = 1; ?>
                    ...
                    <div class="product-widget">
                      ...
                      <div class="product-body">
                        <p class="product-category">Sepatu</p>
          ...
          <div class="row">
            <div class="col-md-3 col-xs-6">
              <div class="footer">
                ...
                <p> Kami adalah toko online yang menyediakan sepatu bermerek non KW belilah belilah
